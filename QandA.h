...
public:
	...
	QandA(std::string question, std::string correctAnswer, std::string wrongAnswer1, std::string wrongAnswer2, std::string wrongAnswer3) { this->question = question; answers[0] = correctAnswer; answers[1] = wrongAnswer1; answers[2] = wrongAnswer2; answers[3] = wrongAnswer3; }
